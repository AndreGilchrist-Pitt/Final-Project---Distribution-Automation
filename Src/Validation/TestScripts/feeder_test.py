...
circuit.add_load("Load_8ind", "8ind", 1.00, 0.30)
...
circuit.add_load("Load_12res", "12res", 1.00, 0.60)
circuit.add_load("Load_13ind", "13ind", 1.00, 0.60)

# -------------------------
# Switched shunts / capacitor banks
# -------------------------
circuit.add_capacitor_bank("Cap_5ind", "5ind", 1.1, status="Closed")
circuit.add_capacitor_bank("Cap_7res", "7res", 1.1, status="Closed")
circuit.add_capacitor_bank("Cap_8ind", "8ind", 1.1, status="Closed")
circuit.add_capacitor_bank("Cap_10res", "10res", 1.1, status="Closed")
circuit.add_capacitor_bank("Cap_12res", "12res", 1.1, status="Closed")
circuit.add_capacitor_bank("Cap_13ind", "13ind", 1.1, status="Closed")
